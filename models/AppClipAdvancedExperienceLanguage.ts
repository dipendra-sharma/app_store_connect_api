...
export function instanceOfAppClipAdvancedExperienceLanguage(value: any): boolean {
    for (const key in AppClipAdvancedExperienceLanguage) {
        if (Object.prototype.hasOwnProperty.call(AppClipAdvancedExperienceLanguage, key)) {
            if (AppClipAdvancedExperienceLanguage[key as keyof typeof AppClipAdvancedExperienceLanguage] === value) {
                return true;
            }
        }
    }
...
export function AppClipAdvancedExperienceLanguageToJSONTyped(value: any, ignoreDiscriminator: boolean): AppClipAdvancedExperienceLanguage {
    return value as AppClipAdvancedExperienceLanguage;
}
