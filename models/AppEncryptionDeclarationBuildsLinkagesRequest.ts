 ...
 */
export function instanceOfAppEncryptionDeclarationBuildsLinkagesRequest(value: object): value is AppEncryptionDeclarationBuildsLinkagesRequest {
...
export function AppEncryptionDeclarationBuildsLinkagesRequestToJSON(json: any): AppEncryptionDeclarationBuildsLinkagesRequest {
    return AppEncryptionDeclarationBuildsLinkagesRequestToJSONTyped(json, false);
}

export function AppEncryptionDeclarationBuildsLinkagesRequestToJSONTyped(value?: AppEncryptionDeclarationBuildsLinkagesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
