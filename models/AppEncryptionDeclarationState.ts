...
export function instanceOfAppEncryptionDeclarationState(value: any): boolean {
    for (const key in AppEncryptionDeclarationState) {
        if (Object.prototype.hasOwnProperty.call(AppEncryptionDeclarationState, key)) {
            if (AppEncryptionDeclarationState[key as keyof typeof AppEncryptionDeclarationState] === value) {
                return true;
            }
        }
    }
...
export function AppEncryptionDeclarationStateToJSONTyped(value: any, ignoreDiscriminator: boolean): AppEncryptionDeclarationState {
    return value as AppEncryptionDeclarationState;
}
