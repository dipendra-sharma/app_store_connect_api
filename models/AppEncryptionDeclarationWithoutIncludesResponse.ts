 ...
 */
export function instanceOfAppEncryptionDeclarationWithoutIncludesResponse(value: object): value is AppEncryptionDeclarationWithoutIncludesResponse {
...
export function AppEncryptionDeclarationWithoutIncludesResponseToJSON(json: any): AppEncryptionDeclarationWithoutIncludesResponse {
    return AppEncryptionDeclarationWithoutIncludesResponseToJSONTyped(json, false);
}

export function AppEncryptionDeclarationWithoutIncludesResponseToJSONTyped(value?: AppEncryptionDeclarationWithoutIncludesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
