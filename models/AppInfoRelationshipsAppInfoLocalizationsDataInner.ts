 ...
 */
export function instanceOfAppInfoRelationshipsAppInfoLocalizationsDataInner(value: object): value is AppInfoRelationshipsAppInfoLocalizationsDataInner {
...
export function AppInfoRelationshipsAppInfoLocalizationsDataInnerToJSON(json: any): AppInfoRelationshipsAppInfoLocalizationsDataInner {
    return AppInfoRelationshipsAppInfoLocalizationsDataInnerToJSONTyped(json, false);
}

export function AppInfoRelationshipsAppInfoLocalizationsDataInnerToJSONTyped(value?: AppInfoRelationshipsAppInfoLocalizationsDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
