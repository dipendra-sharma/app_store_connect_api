...
import {
    ...
    AppInfoUpdateRequestDataToJSONTyped,
 ...
 */
export function instanceOfAppInfoUpdateRequest(value: object): value is AppInfoUpdateRequest {
...
export function AppInfoUpdateRequestToJSON(json: any): AppInfoUpdateRequest {
    return AppInfoUpdateRequestToJSONTyped(json, false);
}

export function AppInfoUpdateRequestToJSONTyped(value?: AppInfoUpdateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
