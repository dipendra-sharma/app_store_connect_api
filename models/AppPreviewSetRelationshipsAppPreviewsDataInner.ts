 ...
 */
export function instanceOfAppPreviewSetRelationshipsAppPreviewsDataInner(value: object): value is AppPreviewSetRelationshipsAppPreviewsDataInner {
...
export function AppPreviewSetRelationshipsAppPreviewsDataInnerToJSON(json: any): AppPreviewSetRelationshipsAppPreviewsDataInner {
    return AppPreviewSetRelationshipsAppPreviewsDataInnerToJSONTyped(json, false);
}

export function AppPreviewSetRelationshipsAppPreviewsDataInnerToJSONTyped(value?: AppPreviewSetRelationshipsAppPreviewsDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
