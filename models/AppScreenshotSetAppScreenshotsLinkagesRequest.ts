 ...
 */
export function instanceOfAppScreenshotSetAppScreenshotsLinkagesRequest(value: object): value is AppScreenshotSetAppScreenshotsLinkagesRequest {
...
export function AppScreenshotSetAppScreenshotsLinkagesRequestToJSON(json: any): AppScreenshotSetAppScreenshotsLinkagesRequest {
    return AppScreenshotSetAppScreenshotsLinkagesRequestToJSONTyped(json, false);
}

export function AppScreenshotSetAppScreenshotsLinkagesRequestToJSONTyped(value?: AppScreenshotSetAppScreenshotsLinkagesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
