 ...
 */
export function instanceOfAppsWithoutIncludesResponse(value: object): value is AppsWithoutIncludesResponse {
...
export function AppsWithoutIncludesResponseToJSON(json: any): AppsWithoutIncludesResponse {
    return AppsWithoutIncludesResponseToJSONTyped(json, false);
}

export function AppsWithoutIncludesResponseToJSONTyped(value?: AppsWithoutIncludesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
