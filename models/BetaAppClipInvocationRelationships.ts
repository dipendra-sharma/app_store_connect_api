...
import {
    ...
    BetaAppClipInvocationRelationshipsBetaAppClipInvocationLocalizationsToJSONTyped,
 ...
 */
export function instanceOfBetaAppClipInvocationRelationships(value: object): value is BetaAppClipInvocationRelationships {
    return true;
}
...
export function BetaAppClipInvocationRelationshipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BetaAppClipInvocationRelationships {
    ...
    return {
        ...
        'betaAppClipInvocationLocalizations': json['betaAppClipInvocationLocalizations'] == null ? undefined : BetaAppClipInvocationRelationshipsBetaAppClipInvocationLocalizationsFromJSON(json['betaAppClipInvocationLocalizations']),
    };
}

export function BetaAppClipInvocationRelationshipsToJSON(json: any): BetaAppClipInvocationRelationships {
    return BetaAppClipInvocationRelationshipsToJSONTyped(json, false);
}

export function BetaAppClipInvocationRelationshipsToJSONTyped(value?: BetaAppClipInvocationRelationships | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
