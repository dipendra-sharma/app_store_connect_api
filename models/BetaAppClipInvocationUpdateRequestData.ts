 ...
 */
export function instanceOfBetaAppClipInvocationUpdateRequestData(value: object): value is BetaAppClipInvocationUpdateRequestData {
...
export function BetaAppClipInvocationUpdateRequestDataToJSON(json: any): BetaAppClipInvocationUpdateRequestData {
    return BetaAppClipInvocationUpdateRequestDataToJSONTyped(json, false);
}

export function BetaAppClipInvocationUpdateRequestDataToJSONTyped(value?: BetaAppClipInvocationUpdateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
