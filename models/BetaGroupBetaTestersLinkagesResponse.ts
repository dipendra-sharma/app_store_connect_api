 ...
 */
export function instanceOfBetaGroupBetaTestersLinkagesResponse(value: object): value is BetaGroupBetaTestersLinkagesResponse {
...
export function BetaGroupBetaTestersLinkagesResponseToJSON(json: any): BetaGroupBetaTestersLinkagesResponse {
    return BetaGroupBetaTestersLinkagesResponseToJSONTyped(json, false);
}

export function BetaGroupBetaTestersLinkagesResponseToJSONTyped(value?: BetaGroupBetaTestersLinkagesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
