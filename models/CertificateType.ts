...
export function instanceOfCertificateType(value: any): boolean {
    for (const key in CertificateType) {
        if (Object.prototype.hasOwnProperty.call(CertificateType, key)) {
            if (CertificateType[key as keyof typeof CertificateType] === value) {
                return true;
            }
        }
    }
...
export function CertificateTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): CertificateType {
