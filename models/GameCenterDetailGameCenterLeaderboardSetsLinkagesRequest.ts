 ...
 */
export function instanceOfGameCenterDetailGameCenterLeaderboardSetsLinkagesRequest(value: object): value is GameCenterDetailGameCenterLeaderboardSetsLinkagesRequest {
...
export function GameCenterDetailGameCenterLeaderboardSetsLinkagesRequestToJSON(json: any): GameCenterDetailGameCenterLeaderboardSetsLinkagesRequest {
    return GameCenterDetailGameCenterLeaderboardSetsLinkagesRequestToJSONTyped(json, false);
}

export function GameCenterDetailGameCenterLeaderboardSetsLinkagesRequestToJSONTyped(value?: GameCenterDetailGameCenterLeaderboardSetsLinkagesRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
