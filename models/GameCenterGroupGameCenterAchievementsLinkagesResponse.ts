 ...
 */
export function instanceOfGameCenterGroupGameCenterAchievementsLinkagesResponse(value: object): value is GameCenterGroupGameCenterAchievementsLinkagesResponse {
...
export function GameCenterGroupGameCenterAchievementsLinkagesResponseToJSON(json: any): GameCenterGroupGameCenterAchievementsLinkagesResponse {
    return GameCenterGroupGameCenterAchievementsLinkagesResponseToJSONTyped(json, false);
}

export function GameCenterGroupGameCenterAchievementsLinkagesResponseToJSONTyped(value?: GameCenterGroupGameCenterAchievementsLinkagesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
