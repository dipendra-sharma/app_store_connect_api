 ...
 */
export function instanceOfGameCenterMatchmakingRulesResponse(value: object): value is GameCenterMatchmakingRulesResponse {
...
export function GameCenterMatchmakingRulesResponseToJSON(json: any): GameCenterMatchmakingRulesResponse {
    return GameCenterMatchmakingRulesResponseToJSONTyped(json, false);
}

export function GameCenterMatchmakingRulesResponseToJSONTyped(value?: GameCenterMatchmakingRulesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
