...
import {
    ...
    GameCenterMatchmakingSessionsV1MetricResponseDataInnerToJSONTyped,
 ...
 */
export function instanceOfGameCenterMatchmakingSessionsV1MetricResponse(value: object): value is GameCenterMatchmakingSessionsV1MetricResponse {
...
export function GameCenterMatchmakingSessionsV1MetricResponseToJSON(json: any): GameCenterMatchmakingSessionsV1MetricResponse {
    return GameCenterMatchmakingSessionsV1MetricResponseToJSONTyped(json, false);
}

export function GameCenterMatchmakingSessionsV1MetricResponseToJSONTyped(value?: GameCenterMatchmakingSessionsV1MetricResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
