...
import {
    ...
    InAppPurchaseLocalizationUpdateRequestDataAttributesToJSONTyped,
 ...
 */
export function instanceOfInAppPurchaseLocalizationUpdateRequestData(value: object): value is InAppPurchaseLocalizationUpdateRequestData {
...
export function InAppPurchaseLocalizationUpdateRequestDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): InAppPurchaseLocalizationUpdateRequestData {
    ...
    return {
        ...
        'type': json['type'],
        'id': json['id'],
        'attributes': json['attributes'] == null ? undefined : InAppPurchaseLocalizationUpdateRequestDataAttributesFromJSON(json['attributes']),
    };
}

export function InAppPurchaseLocalizationUpdateRequestDataToJSON(json: any): InAppPurchaseLocalizationUpdateRequestData {
    return InAppPurchaseLocalizationUpdateRequestDataToJSONTyped(json, false);
}

export function InAppPurchaseLocalizationUpdateRequestDataToJSONTyped(value?: InAppPurchaseLocalizationUpdateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
