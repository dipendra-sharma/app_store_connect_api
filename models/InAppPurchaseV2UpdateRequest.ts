...
import {
    ...
    InAppPurchaseV2UpdateRequestDataToJSONTyped,
 ...
 */
export function instanceOfInAppPurchaseV2UpdateRequest(value: object): value is InAppPurchaseV2UpdateRequest {
...
export function InAppPurchaseV2UpdateRequestToJSON(json: any): InAppPurchaseV2UpdateRequest {
    return InAppPurchaseV2UpdateRequestToJSONTyped(json, false);
}

export function InAppPurchaseV2UpdateRequestToJSONTyped(value?: InAppPurchaseV2UpdateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
