...
export function instanceOfKidsAgeBand(value: any): boolean {
    for (const key in KidsAgeBand) {
        if (Object.prototype.hasOwnProperty.call(KidsAgeBand, key)) {
            if (KidsAgeBand[key as keyof typeof KidsAgeBand] === value) {
                return true;
            }
        }
    }
...
export function KidsAgeBandToJSONTyped(value: any, ignoreDiscriminator: boolean): KidsAgeBand {
    return value as KidsAgeBand;
}
