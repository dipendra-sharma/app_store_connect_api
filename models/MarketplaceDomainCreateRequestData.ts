 ...
 */
export function instanceOfMarketplaceDomainCreateRequestData(value: object): value is MarketplaceDomainCreateRequestData {
...
export function MarketplaceDomainCreateRequestDataToJSON(json: any): MarketplaceDomainCreateRequestData {
    return MarketplaceDomainCreateRequestDataToJSONTyped(json, false);
}

export function MarketplaceDomainCreateRequestDataToJSONTyped(value?: MarketplaceDomainCreateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
