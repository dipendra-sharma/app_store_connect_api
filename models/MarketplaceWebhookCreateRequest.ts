...
import {
    ...
    MarketplaceWebhookCreateRequestDataToJSONTyped,
 ...
 */
export function instanceOfMarketplaceWebhookCreateRequest(value: object): value is MarketplaceWebhookCreateRequest {
...
export function MarketplaceWebhookCreateRequestToJSON(json: any): MarketplaceWebhookCreateRequest {
    return MarketplaceWebhookCreateRequestToJSONTyped(json, false);
}

export function MarketplaceWebhookCreateRequestToJSONTyped(value?: MarketplaceWebhookCreateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
