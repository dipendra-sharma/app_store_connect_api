 ...
 */
export function instanceOfRoutingAppCoverageCreateRequestData(value: object): value is RoutingAppCoverageCreateRequestData {
...
export function RoutingAppCoverageCreateRequestDataToJSON(json: any): RoutingAppCoverageCreateRequestData {
    return RoutingAppCoverageCreateRequestDataToJSONTyped(json, false);
}

export function RoutingAppCoverageCreateRequestDataToJSONTyped(value?: RoutingAppCoverageCreateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
