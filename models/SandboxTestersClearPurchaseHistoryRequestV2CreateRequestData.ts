...
import {
    ...
    SandboxTestersClearPurchaseHistoryRequestV2CreateRequestDataRelationshipsToJSONTyped,
 ...
 */
export function instanceOfSandboxTestersClearPurchaseHistoryRequestV2CreateRequestData(value: object): value is SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData {
...
export function SandboxTestersClearPurchaseHistoryRequestV2CreateRequestDataToJSON(json: any): SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData {
    return SandboxTestersClearPurchaseHistoryRequestV2CreateRequestDataToJSONTyped(json, false);
}

export function SandboxTestersClearPurchaseHistoryRequestV2CreateRequestDataToJSONTyped(value?: SandboxTestersClearPurchaseHistoryRequestV2CreateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
