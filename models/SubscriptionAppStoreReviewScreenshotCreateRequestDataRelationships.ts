 ...
 */
export function instanceOfSubscriptionAppStoreReviewScreenshotCreateRequestDataRelationships(value: object): value is SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationships {
...
export function SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationshipsToJSON(json: any): SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationships {
    return SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationshipsToJSONTyped(json, false);
}

export function SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationshipsToJSONTyped(value?: SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationships | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
