 ...
 */
export function instanceOfSubscriptionAttributes(value: object): value is SubscriptionAttributes {
    return true;
}
...
export function SubscriptionAttributesToJSON(json: any): SubscriptionAttributes {
    return SubscriptionAttributesToJSONTyped(json, false);
}

export function SubscriptionAttributesToJSONTyped(value?: SubscriptionAttributes | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
