 ...
 */
export function instanceOfSubscriptionCreateRequestDataRelationships(value: object): value is SubscriptionCreateRequestDataRelationships {
...
export function SubscriptionCreateRequestDataRelationshipsToJSON(json: any): SubscriptionCreateRequestDataRelationships {
    return SubscriptionCreateRequestDataRelationshipsToJSONTyped(json, false);
}

export function SubscriptionCreateRequestDataRelationshipsToJSONTyped(value?: SubscriptionCreateRequestDataRelationships | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
