 ...
 */
export function instanceOfSubscriptionLocalizationUpdateRequestData(value: object): value is SubscriptionLocalizationUpdateRequestData {
...
export function SubscriptionLocalizationUpdateRequestDataToJSON(json: any): SubscriptionLocalizationUpdateRequestData {
    return SubscriptionLocalizationUpdateRequestDataToJSONTyped(json, false);
}

export function SubscriptionLocalizationUpdateRequestDataToJSONTyped(value?: SubscriptionLocalizationUpdateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
