...
import {
    ...
    SubscriptionOfferCodeCustomCodeCreateRequestDataAttributesToJSONTyped,
 ...
 */
export function instanceOfSubscriptionOfferCodeCustomCodeCreateRequestData(value: object): value is SubscriptionOfferCodeCustomCodeCreateRequestData {
...
export function SubscriptionOfferCodeCustomCodeCreateRequestDataToJSON(json: any): SubscriptionOfferCodeCustomCodeCreateRequestData {
    return SubscriptionOfferCodeCustomCodeCreateRequestDataToJSONTyped(json, false);
}

export function SubscriptionOfferCodeCustomCodeCreateRequestDataToJSONTyped(value?: SubscriptionOfferCodeCustomCodeCreateRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
