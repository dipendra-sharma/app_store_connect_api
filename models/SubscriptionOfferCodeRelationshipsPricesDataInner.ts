 ...
 */
export function instanceOfSubscriptionOfferCodeRelationshipsPricesDataInner(value: object): value is SubscriptionOfferCodeRelationshipsPricesDataInner {
...
export function SubscriptionOfferCodeRelationshipsPricesDataInnerToJSON(json: any): SubscriptionOfferCodeRelationshipsPricesDataInner {
    return SubscriptionOfferCodeRelationshipsPricesDataInnerToJSONTyped(json, false);
}

export function SubscriptionOfferCodeRelationshipsPricesDataInnerToJSONTyped(value?: SubscriptionOfferCodeRelationshipsPricesDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
