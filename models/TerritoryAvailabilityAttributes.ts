...
export const TerritoryAvailabilityAttributesContentStatusesEnum = {
    ...
    IcpNumberInvalid: 'ICP_NUMBER_INVALID',
    IcpNumberMissing: 'ICP_NUMBER_MISSING',
 ...
 */
export function instanceOfTerritoryAvailabilityAttributes(value: object): value is TerritoryAvailabilityAttributes {
    return true;
}
...
export function TerritoryAvailabilityAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): TerritoryAvailabilityAttributes {
    ...
    return {
        ...
        'preOrderPublishDate': json['preOrderPublishDate'] == null ? undefined : (new Date(json['preOrderPublishDate'])),
        'contentStatuses': json['contentStatuses'] == null ? undefined : json['contentStatuses'],
    };
}

export function TerritoryAvailabilityAttributesToJSON(json: any): TerritoryAvailabilityAttributes {
    return TerritoryAvailabilityAttributesToJSONTyped(json, false);
}

export function TerritoryAvailabilityAttributesToJSONTyped(value?: TerritoryAvailabilityAttributes | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'preOrderPublishDate': value['preOrderPublishDate'] == null ? undefined : ((value['preOrderPublishDate']).toISOString().substring(0,10)),
